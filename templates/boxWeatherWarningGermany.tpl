        ...
        {if $viewMapInfo}
            <div class="germanyMapInfo">
                <div class="legendBoxContainer">
                    <div>
                        <div class="legendBox warningLegend1" style="--weatherWarningLegendColor: rgba(136, 14, 79, 1)">
                        </div>
                        <div class="legendBoxText">{lang}wcf.weatherWarning.dwd.legend1{/lang}</div>
                    </div>
                    <div>
                        <div class="legendBox warningLegend2" style="--weatherWarningLegendColor: rgba(229, 57, 53, 1)">
                        </div>
                    ...
                    <div>
                        <div class="legendBox warningLegend4" style="--weatherWarningLegendColor: rgba(255, 235, 59, 1)">
                        </div>
                    ...
                    {if $__wcf->getLanguage()->getFixedLanguageCode() === "de"}
                        <div>
                            <div class="legendBox warningLegend6" style="--weatherWarningLegendColor: rgba(158, 70, 248, 1)">
                            </div>
                            <div class="legendBoxText">{lang}wcf.weatherWarning.dwd.legend6{/lang}</div>
                        </div>
                    {/if}
                    <div>
                        <div class="legendBox warningLegend7" style="--weatherWarningLegendColor: rgba(204, 153, 255, 1)">
                        </div>
                        <div class="legendBoxText">{lang}wcf.weatherWarning.dwd.legend7{/lang}</div>
                    </div>
                    <div>
                        <div class="legendBox warningLegend8" style="--weatherWarningLegendColor: rgba(254, 104, 254, 1)">
                        </div>
                        <div class="legendBoxText">{lang}wcf.weatherWarning.dwd.legend8{/lang}</div>
                    </div>
                    <div>
                        <div class="legendBox warningLegend9" style="--weatherWarningLegendColor: rgba(197, 229, 102, 1)">
                        </div>
