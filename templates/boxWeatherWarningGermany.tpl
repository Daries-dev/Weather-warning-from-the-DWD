    ...
    <div class="weatherWarningMap">
        ...
        <div class="germanyMapInfo">
            <div class="legendBoxContainer">
                <div>
                    <div class="legendBox" style="--weatherWarningLegendColor: rgba(136, 14, 79, 1)"></div>
                    <div class="legendBoxText">{lang}wcf.weatherWarning.dwd.legend1{/lang}</div>
                </div>
                <div>
                    <div class="legendBox" style="--weatherWarningLegendColor: rgba(229, 57, 53, 1)"></div>
                    <div class="legendBoxText">{lang}wcf.weatherWarning.dwd.legend2{/lang}</div>
                </div>
                <div>
                    <div class="legendBox" style="--weatherWarningLegendColor: rgba(261, 146, 0, 1)"></div>
                    <div class="legendBoxText">{lang}wcf.weatherWarning.dwd.legend3{/lang}</div>
                </div>
                <div>
                    <div class="legendBox" style="--weatherWarningLegendColor: rgba(255, 235, 59, 1)"></div>
                    <div class="legendBoxText">{lang}wcf.weatherWarning.dwd.legend4{/lang}</div>
                </div>
                <div>
                    <div class="legendBox preliminary" style="--weatherWarningLegendColor: rgba(255, 255, 255, 1)"></div>
                    <div class="legendBoxText">{lang}wcf.weatherWarning.dwd.legend5{/lang}</div>
                </div>
                {if $__wcf->getLanguage()->getFixedLanguageCode() === "de"}
                    <div>
                        <div class="legendBox" style="--weatherWarningLegendColor: rgba(158, 70, 248, 1)"></div>
                        <div class="legendBoxText">{lang}wcf.weatherWarning.dwd.legend6{/lang}</div>
                    </div>
                {/if}
                <div>
                    <div class="legendBox" style="--weatherWarningLegendColor: rgba(204, 153, 255, 1)"></div>
                    <div class="legendBoxText">{lang}wcf.weatherWarning.dwd.legend7{/lang}</div>
                </div>
                <div>
                    <div class="legendBox" style="--weatherWarningLegendColor: rgba(254, 104, 254, 1)"></div>
                    <div class="legendBoxText">{lang}wcf.weatherWarning.dwd.legend8{/lang}</div>
                </div>
                <div>
                    <div class="legendBox" style="--weatherWarningLegendColor: rgba(197, 229, 102, 1)"></div>
